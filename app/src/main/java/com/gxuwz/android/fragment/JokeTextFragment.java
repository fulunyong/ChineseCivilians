...
import com.gxuwz.android.adapter.JokeTextAdapter;
...
public class JokeTextFragment extends Fragment{
    ...
    private void initAdapter() {
        if (dataList == null) {
            dataList = new ArrayList<JokeTextBean>();
        }
        if (adapter == null) {
            adapter = new JokeTextAdapter(dataList, getActivity());
        }
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case BackstageService.RESULT_OK:
                    ...
                    ArrayList<JokeTextBean> list = msg.getData().getParcelableArrayList("dataList");
    ...
    private void requestInternetData() {
        Message msg = Message.obtain(null,BackstageService.MESSAGE_WHAT_JOKE_TEXT, 0, 0);
